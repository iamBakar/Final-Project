...
Memory::Memory(const char* id, Object* sharedBy, const char* text, const date& shareDay, Post* originalPost) : Post(id, sharedBy, text, shareDay), originalPost(originalPost){}
